 ...
 * @author tinku
 */
public class submit_resourse extends HttpServlet {
...
// HttpSession session=request.getSession();
 // String designation= (String) session.getAttribute("profile");
    ...
    Teacher pr = (Teacher)session.getAttribute(designation);
 //   out.println(value[1] + value[0] + filename);
   pr.sendResourse(value[1], value[0], filename);
...
String url="Error Sending Message";
    if (designation.equals("teacher"))
    {
       url="tcindex.jsp?msg=Resourse has been Succefully Uploaded";
    }
