...
<html lang="en">
 ...
 if (designation.equals("student"))
     {
       pr = (Student)session.getAttribute(designation);
    teacher_name= pr.getRecievers();
...
<ul>
			...
			<div id="content">
				...
				<h2><img src="images/icons/tools_32.png" alt="Manage Users" />Send Messages</h2>
						...
						<form action="submit_message" ENCTYPE=multipart/form-data METHOD=POST>
					      ...
					      <label>Select an option</label>
									<select name="reciever">
                                                                            ...
                                                                            for ()
										<option><%= teacher_name[i]%> </option>
										<% }%>
									</select>
									<small>Select Reciever from the list.</small>
							</p>
