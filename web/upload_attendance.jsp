...
<li>
						<a href="upload_attendance.jsp" class="current">
							Upload Attendance
						</a>
			...
			<div id="content">
				...
				<h2><img src="images/icons/tools_32.png" alt="Manage Users" />Upload Attendance</h2>
	      ...
	      <div class="clear"></div>
				...
				<div class="content-box">
				    ...
				    <form action="submit_attendance"  METHOD="GET">
						  <fieldset>



                            <p>
                                <input type="text"  class="medium" name="lectures" value="Total Lectures">
                            </p>
                             <p>
                                     <select name="month" >
					      ...
					      <label>Select an option</label>
                                    ...
                                    <option onclick=openURL("tajax_section.jsp?class_name=<%= class_name[i]%>","section")><%= class_name[i]%> </option>
										<% }%>
									</select>
