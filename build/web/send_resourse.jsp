...
<li>
						<a href="send_resourse.jsp" class="current">
						Send Resources
					</a>
...
<li>
			...
			<div id="content">
				...
				<h2><img src="images/icons/tools_32.png" alt="Manage Users" />Send Resourses</h2>
	      ...
	      <div class="clear"></div>
				...
				<div class="content-box">
					<div class="content-box-header">
						<h3>Send Resourses</h3>
					</div>

					<div class="content-box-content">
				    <form action="submit_resourse" ENCTYPE=multipart/form-data METHOD=POST>
						  <fieldset>
							  <p>
