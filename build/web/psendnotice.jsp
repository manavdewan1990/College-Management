...
<li>
						<a href="psendnotice.jsp" class="current">
						SendNotice</a>
...
<li>
			...
			<div id="content">
				...
				<h2><img src="images/icons/tools_32.png" alt="Manage Users" />Send Notice</h2>
	      ...
	      <div class="clear"></div>
				...
				<div class="content-box">
					...
					<div class="content-box-content">
						<form action="submit_notice" ENCTYPE=multipart/form-data METHOD=POST>
						  <fieldset>
						    <p>
